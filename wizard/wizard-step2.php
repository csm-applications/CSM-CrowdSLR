...
function parseCSVtoJson($csv){
	...
	$pr1 = str_replace('\ufeff',"",json_encode($final_data));
	$pr2 = str_replace('\"',"",$pr1);
	file_put_contents("../data/task.json",	$pr2);
...
<body class="container">
	<div>
		<h1 class="display-4" style="padding: 2em; text-align: center; background-color: fafafa;" >Wizard</h1>
	</div>

	<div class="card display-4" style="padding:20px">Step 02 - Upload your task data</div>
